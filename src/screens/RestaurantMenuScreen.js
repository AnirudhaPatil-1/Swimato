...
const RestaurantMenuScreen = () => {
	...
	const itemCards = restaurant?.cards[2].groupedCard?.cardGroupMap?.REGULAR.cards[2].card.card.itemCards;
  	console.log(itemCards);
  	const basicInfo = restaurant?.cards[0]?.card?.card?.info;
	const discountInfo = basicInfo?.aggregatedDiscountInfo?.descriptionList;
	//@ end
	...
	// 	//@
	// 	const array = Object.values(basicInfo);
			...
			<>
				<div className="restaurantDetailscontainer">
					...
					<div className="restaurantDetails">
						...
						<p className="color_light_secondary font_size_large">
							...
							{/* {basicInfo.city} / {basicInfo.areaName} / {basicInfo.name}{" "} */}
						</p>
						...
						<div className="restaurantDetailsFooter">
							...
							<div>
								...
								<p className="color_light">{basicInfo.sla.slaString}</p>
							...
							<div>
								<p className="color_light">
									...
									{"₹ " + basicInfo.costForTwo / 100}
								</p>
								<p className="color_light_secondary font_size_small m_t_6 fw_thin">
									{/* {restaurant.costForTwoMsg} */}
									{basicInfo.costForTwoMessage}
								</p>
							</div>
						</div>
					</div>
					...
					<div className="restaurantDetailsOfferContainer">
						<IconWithRightLabel
							...
							text={basicInfo.aggregatedDiscountInfo.descriptionList[0].meta}
						/>
						...
						<div className="m_t_16">
							<IconWithRightLabel
								...
								text={basicInfo.aggregatedDiscountInfo.descriptionList[1].meta}
							/>
						</div>
					</div>
				</div>
				<div className="recommendedSectionContainer">
					<div className="recommendedListContainer">
						...
						{/* <h2 className="font_size_xl ">Cuisines</h2> */}
						<div className="font_size_medium color_light_secondary_dark">
						<h2 className="font_size_xl ">Cuisines</h2>
					...
					<div className="recommendedItemsContainer">
						<div className="recommendedItemsHeader">
							...
							<p className="font_size_small color_light_secondary_dark">
								...
								{/* {Object.values(itemCards?.menu.items).length} ITEMS */}
									...
									{/* const itemInfo = item.card.info; */}
										...
										>
											<div>
												...
												<p className="fw_medium font_size_xl font hover: font-bold">{item.card.info.name}</p>
											...
											<div className="recommendedItemImageContainer">
												{/* <img src={URL + item.card.info.imageId} /> */}
						...
						{cartItems.map((item) => {
									return (
										<div className="">
											...
											<p className=" w-36 text-sm">{item.card.info.name}</p>
											<div className="px-5">
												<Cta item={item} />
											</div>
											...
											<p className="font-thin text-sm">
												{"₹ " + (item.card.info.price / 100) * item.card.info.itemQuantity}
											</p>
										</div>
									</div>
								);
